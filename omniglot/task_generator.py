...
def omniglot_character_folders():
    data_folder = '/content/LeaningToCompare/datas/omniglot_resized/'
...
#     normalize = transforms.Compose([Rotate(rotation), transforms.ToTensor(),
...
#     dataset = Omniglot(task,split=split,transform=normalize)
